...
import io.slingcms.core.diagrams.io.gliffy.importer.GliffyDiagramConverter;
import io.slingcms.core.diagrams.io.mxCodec;
import io.slingcms.core.diagrams.io.mxGraphMlCodec;
 ...
 */
@Component(service = Servlet.class, property = { "sling.servlet.paths=/bin/diagrams/open",
        "sling.servlet.methods=" + HttpConstants.METHOD_POST })
public class OpenServlet extends SlingAllMethodsServlet
{
	/**
	 * 
	 */
