...
import io.slingcms.core.diagrams.canvas.mxImageCanvas;
import io.slingcms.core.diagrams.model.*;
...
public class mxGraph extends mxEventSource
{
	...
	static
	{
		try
		{
			mxResources.add("io.slingcms.core.diagrams.resources.graph");
		}
		catch (Exception e)
		{
	 ...
	 * {@link io.slingcms.core.diagrams.model.mxGraphModel}.
	 */
	public mxGraph()
	{
		this(null, null);
	 ...
	 * specified, then a new, empty {@link io.slingcms.core.diagrams.model.mxGraphModel} is
	 * used.
	 * 
