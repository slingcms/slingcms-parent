...
public class mxPerimeter
{
	...
	public static mxPerimeterFunction RectanglePerimeter = new mxPerimeterFunction()
	{
		...
		/* (non-Javadoc)
		 * @see io.slingcms.core.diagrams.view.mxPerimeter.mxPerimeterFunction#apply
		 */
	...
	public static mxPerimeterFunction TrianglePerimeter = new mxPerimeterFunction()
	{
		...
		/* (non-Javadoc)
		 * @see io.slingcms.core.diagrams.view.mxPerimeter.mxPerimeterFunction#apply(io.slingcms.core.diagrams.utils.mxRectangle, io.slingcms.core.diagrams.view.mxCellState, io.slingcms.core.diagrams.view.mxCellState, boolean, io.slingcms.core.diagrams.utils.mxPoint)
		 */
		public mxPoint apply(mxRectangle bounds, mxCellState vertex,
				mxPoint next, boolean orthogonal)
		{
