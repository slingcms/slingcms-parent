...
public class mxEdgeStyle
{
	...
	public static mxEdgeStyleFunction EntityRelation = new mxEdgeStyleFunction()
	{
		...
		/* (non-Javadoc)
		 * @see io.slingcms.core.diagrams.view.mxEdgeStyle.mxEdgeStyleFunction#apply(io.slingcms.core.diagrams.view.mxCellState, io.slingcms.core.diagrams.view.mxCellState, io.slingcms.core.diagrams.view.mxCellState, java.util.List, java.util.List)
		 */
