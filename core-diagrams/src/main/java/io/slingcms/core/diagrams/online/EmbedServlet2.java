 ...
 */
@Component(service = Servlet.class, property = { "sling.servlet.paths=/bin/diagrams/embed.js",
        "sling.servlet.methods=" + HttpConstants.METHOD_GET })
@Designate(ocd = EmbedServlet2Config.class, factory = true)
public class EmbedServlet2 extends SlingAllMethodsServlet
{
	/**
	 * 
	 */
    ...
    @Activate
    public void activate(ConverterServletConfig config) {

        applicationVersion = config.apiKey();
